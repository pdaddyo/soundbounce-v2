...
const debug = _debug('soundbounce:webpack:config');
...
webpackConfig.output = {
	filename: `client/js/[name].[${config.compiler_hash_type}].js`,
...
webpackConfig.module.loaders.push(
	{
		test: /\.woff(\?.*)?$/,
		loader: 'file?name=client/fonts/[name].[ext]&limit=10000&mimetype=application/font-woff'
	},
	{
		test: /\.woff2(\?.*)?$/,
